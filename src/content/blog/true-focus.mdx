...
<LiveStep
  codeId="true-focus-final"
  controls={[
    { type: 'slider', prop: 'blurAmount', label: 'blurAmount', min: 2, max: 10, default: 5 },
    { type: 'color', prop: 'borderColor', label: 'borderColor', default: '#000000' },
  ]}
/>
