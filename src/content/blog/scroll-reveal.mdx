...
## The version without GSAP

Modern CSS can drive this same reveal off the scrollbar directly, with `animation-timeline: view()` and no library. [Scroll Reveal Text with Zero JavaScript](/blog/scroll-reveal-css) builds it from scratch and covers what you give up, which is mainly the progress value and the callbacks that GSAP hands you here.
