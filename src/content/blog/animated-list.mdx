...
A scrollable list where each item animates in with a scale and opacity transition when it enters the viewport. Items also react to hover and click, and keyboard navigation is fully supported.
