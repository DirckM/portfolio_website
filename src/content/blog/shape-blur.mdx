...
<LiveStep codeId="shape-blur-final" controls={[
  { type: "slider", id: "shapeSize", label: "Shape Size", min: 0.5, max: 2, step: 0.1, default: 1.2 },
  { type: "slider", id: "roundness", label: "Roundness", min: 0, max: 1, step: 0.1, default: 0.4 }
]} />
