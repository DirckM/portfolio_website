...
<LiveStep codeId="light-pillar-final" previewBg="bg-black" controls={[{ type: "color", prop: "topColor", label: "Top Color", default: "#5227FF" }, { type: "color", prop: "bottomColor", label: "Bottom Color", default: "#FF9FFC" }]} />
