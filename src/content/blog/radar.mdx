...
<LiveStep codeId="radar-final" previewBg="bg-black" controls={[{ type: "color", prop: "color", label: "Color", default: "#00ff88" }, { type: "slider", prop: "sweepSpeed", label: "Sweep Speed", min: 0.5, max: 3, step: 0.5, default: 1 }]} />
