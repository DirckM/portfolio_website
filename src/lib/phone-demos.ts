...
export const phoneDemos: Record<string, PhoneDemoData> = {
  'dishy-onboarding': {
    ...
    chapters: [
      ...
      { at: 3.6, label: 'What should get easier' },
      { at: 7.9, label: 'Household and budget' },
      { at: 17.1, label: 'Where you shop' },
      { at: 32.3, label: 'Time, kitchen, diet' },
      { at: 43.9, label: 'Taste, yes or no' },
      { at: 57.6, label: 'Your first week' },
    ],
  },
  'dishy-mealprep': {
    ...
    chapters: [
      ...
      { at: 5.6, label: 'A photo of the fridge' },
      { at: 13.6, label: 'What you have comes off the list' },
      { at: 17.8, label: 'Every dish cooked together' },
      { at: 23.3, label: 'One step at a time' },
      { at: 42.5, label: 'A dish is done' },
    ],
  },
};
