      ...
      <section id='about' className='py-32'>
        <div className='max-w-5xl mx-auto px-6 md:px-16'>
          ...
          <div ref={containerRef} className='max-w-3xl'>
            <VariableProximity
              label="Hi, I'm Dirck. I've been creating things my whole life. When I was young, I got my first Arduino, and from that moment on, building and experimenting became my passion. I've always loved discovering new ideas, tools, and skills to unlock. At just 16, I started my first small business making bracelets from recycled fishing nets because I wanted to experience what it's like to make real business decisions and see an idea come to life. I have a bachelor's degree in Computer Science. Over the past few years, I've learned a lot, not only about technology, but also about problem-solving and persistence. The biggest lesson for me has been that with enough dedication, any problem can be solved. Sometimes the odds are against you, but it's up to you to turn that around. Now, I'm looking forward to new challenges that will help me grow, learn, and keep creating."
